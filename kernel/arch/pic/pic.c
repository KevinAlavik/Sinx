...
{
    dprintf("Configuring PIC with offsets 0x%04llX and "
            "0x%04llX, AutoEOI: %s\n",
...
void i8259_Disable()
{
    dprintf("Disabling PIC\n");
    i8259_SetMask(0xFFFF);
}

void i8259_Enable()
{
    dprintf("Enabling PIC\n");
...
{
    dprintf("Reading IRQ Request Register\n");
...
{
    dprintf("Reading In-Service Register\n");
