...
$(BIN_DIR)/kernel.img: $(BUILD_DIR)/boot.o $(KERNEL_C_FILES:%.c=$(BUILD_DIR)/%.o)
	$(CC) -T linker.ld -o $@ -ffreestanding -O2 -nostdlib $(BUILD_DIR)/boot.o $(KERNEL_C_FILES:%.c=$(BUILD_DIR)/%.o) -lgcc
